...
const contacts = [
  {
    ...
    gradient: 'from-category-services-accent to-category-services-accent',
    cardGradient: 'from-category-services-start to-category-services-end',
    textColor: 'text-category-services-accent',
    borderAccent: 'border-l-category-services-accent',
  },
  {
    icon: HeartPulse,
    service: 'Ambulance',
