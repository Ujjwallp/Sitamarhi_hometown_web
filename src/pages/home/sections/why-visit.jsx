...
const reasons = [
  {
    ...
    gradient: 'from-category-sacred-accent to-category-sacred-accent',
    cardGradient: 'from-category-sacred-start to-category-sacred-end',
    border: 'border-category-sacred-border',
    hoverBorder: 'hover:border-category-sacred-accent',
    textAccent: 'text-category-sacred-accent',
  ...
  },
  {
    ...
    gradient: 'from-category-heritage-accent to-category-heritage-accent',
    cardGradient: 'from-category-heritage-start to-category-heritage-end',
    border: 'border-category-heritage-border',
    hoverBorder: 'hover:border-category-heritage-accent',
    textAccent: 'text-category-heritage-accent',
  ...
  },
  {
    ...
    gradient: 'from-category-culture-accent to-category-culture-accent',
    cardGradient: 'from-category-culture-start to-category-culture-end',
    border: 'border-category-culture-border',
    hoverBorder: 'hover:border-category-culture-accent',
    textAccent: 'text-category-culture-accent',
